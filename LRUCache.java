...
public class LRUCache {
    ...
    private LinkedHashMap<Character, Boolean> cache;

    public LRUCache() {
        // Initialize the LinkedHashMap with access order
        cache = new LinkedHashMap<Character, Boolean>(MAX_CACHE_SIZE, 0.75f, true) {
            @Override
